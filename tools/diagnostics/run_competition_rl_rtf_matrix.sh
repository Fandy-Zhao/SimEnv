...
MATRIX[M8]="WORLD_MODE=competition PHYSICS_PROFILE=normal GUI=true START_CONTROLLER=1 ENABLE_SENSOR_DATA=1 ENABLE_POINTCLOUD_CONVERTER=1 ENABLE_FAST_LIO2=1 ENABLE_RVIZ=1 ENABLE_REFEREE_ODOM=1 ENABLE_GROUND_TRUTH=1 START_BUILDING_CONTROL=1 RL_POLICY_PATH=$POLICY_PATH_DEFAULT"
