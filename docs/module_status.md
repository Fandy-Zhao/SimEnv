...
> **2026-07-13 update**: FAST-LIO2 Stage 0 & 1 部署测试通过; `simenv_fast_lio2_mapping.launch` 修复 3 个 bug; 新增 `docs/cli-reference.md` 命令速查; 更新 `docs/README.md` 和 `docs/quick-start.md` (exp/0713-fast-lio2-stage01).
