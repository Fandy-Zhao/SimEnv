...
| `unitree_guide` | A1 robot controller + RL locomotion | partial validation | Torch build + headless FixedStand/Trotting + zero/forward/invalid Twist | Trotting directionally functional but under-speed; RL policy contract unresolved |
