...
struct TimingRecord {
    ...
    std::uint64_t fsm_sequence = 0;
    std::uint64_t estimator_sequence = 0;
    std::uint64_t estimator_source_state_sequence = 0;
    std::uint64_t wave_sequence = 0;
    std::uint64_t gait_cycle_sequence = 0;
    std::uint64_t reset_generation = 0;
    std::uint64_t runtime_ctrl_dt_us = 0;
    double target_control_hz = 0.0;
    bool control_update_accepted = false;
    bool new_state_consumed = false;
    bool repeated_state_consumed = false;
    bool scheduler_accepted = false;
    std::uint64_t accepted_state_sequence = 0;
    std::uint64_t scheduler_lag_us = 0;
    std::uint64_t missed_periods = 0;
    std::uint64_t repeated_state_rejected_count = 0;
    int fsm_state = 0;
    int wave_status = 0;
    double resolved_vx = 0.0;
    double resolved_vy = 0.0;
    double resolved_yaw_rate = 0.0;
