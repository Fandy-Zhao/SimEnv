...
export TIMING_DIAGNOSTICS_PATH='/home/zzf/search_ws/SimEnv_worktrees/competition-rl-rtf-collapse/experiments/runs/0723_competition_rl_rtf_collapse/M2/timing.csv'
bash ./auto.sh
